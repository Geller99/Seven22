...
export default function AboutUs() {
  return (
    ...
    <div className="about-us" id="the-project-section">
        ...
        <div className="main-container">
          ...
          <div className="image-container-wrapper-mobile">
            ...
            <div className="image-container-1">
             ...
             <div className='image-contain'> <img src="/assets/images/nft3.jpg" alt="" /></div>
              <div className="lines">
                <div></div>
                <div></div>
              </div>
            ...
            <div className='image-contain-2'>   <img src="/assets/images/Rectangle 5.jpg" alt="" /></div>
              <div className="lines">
                <div></div>
                <div></div>
              </div>
